...
class ModelBasedRL(object):
    ...
    def _train_policy(self, dataset):
        ...
        for epoch in range(self._training_epochs):
            for data_batch in dataset.random_iterator(self._training_batch_size):
                state, action, next_state, _, _ = data_batch
    ...
    def run_q1(self):
        ...
        for r_num, (states, actions, _, _, _) in enumerate(self._random_dataset.rollout_iterator()):
            ...
            for a in actions:
                current_state = self._policy.predict(current_state, a)
    ...
    def run_q2(self):
        ...
        ### PROBLEM 2
        ### YOUR CODE HERE
        eval_dataset = self._gather_rollouts(self._policy, 1)
